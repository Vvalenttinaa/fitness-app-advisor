...
public class ConnectionPool {
    ...
    static {
        String jdbcURL = "jdbc:mysql://localhost:3306/fitness_app_db?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
